...
The plugin is compatible with all IntelliJ-based IDEs starting from the version 2021.3.1, with the following differences in the sets of the available features:
