...
public class RustBitXorBinExprImpl extends RustBinaryExprImpl implements RustBitXorBinExpr {

  public RustBitXorBinExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitBitXorBinExpr(this);
