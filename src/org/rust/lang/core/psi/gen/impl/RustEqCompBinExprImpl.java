...
public class RustEqCompBinExprImpl extends RustBinaryExprImpl implements RustEqCompBinExpr {

  public RustEqCompBinExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitEqCompBinExpr(this);
