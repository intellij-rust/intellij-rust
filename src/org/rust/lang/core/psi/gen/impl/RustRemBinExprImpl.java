...
public class RustRemBinExprImpl extends RustBinaryExprImpl implements RustRemBinExpr {

  public RustRemBinExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitRemBinExpr(this);
