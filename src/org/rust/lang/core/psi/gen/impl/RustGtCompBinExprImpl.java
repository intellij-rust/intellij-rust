...
public class RustGtCompBinExprImpl extends RustBinaryExprImpl implements RustGtCompBinExpr {

  public RustGtCompBinExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitGtCompBinExpr(this);
