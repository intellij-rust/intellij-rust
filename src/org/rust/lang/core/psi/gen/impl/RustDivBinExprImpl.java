...
public class RustDivBinExprImpl extends RustBinaryExprImpl implements RustDivBinExpr {

  public RustDivBinExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitDivBinExpr(this);
