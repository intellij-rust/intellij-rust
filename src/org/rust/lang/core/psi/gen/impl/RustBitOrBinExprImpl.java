...
public class RustBitOrBinExprImpl extends RustBinaryExprImpl implements RustBitOrBinExpr {

  public RustBitOrBinExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitBitOrBinExpr(this);
