...
public class RustLtCompBinExprImpl extends RustBinaryExprImpl implements RustLtCompBinExpr {

  public RustLtCompBinExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitLtCompBinExpr(this);
