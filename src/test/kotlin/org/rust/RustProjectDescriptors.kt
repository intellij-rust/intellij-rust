...
import org.rust.RsTestCase.Companion.testDefaultCfg
import org.rust.RsTestCase.Companion.testDefaultCfgStdLib
...
open class RustProjectDescriptorBase : LightProjectDescriptor() {
    ...
    open fun testCargoProject(module: Module, contentRoot: String): CargoWorkspace {
        ...
        return CargoWorkspace.deserialize(Paths.get("/my-crate/Cargo.toml"), CargoWorkspaceData(packages, emptyMap()), testDefaultCfg)
    }
...
open class WithRustup(private val delegate: RustProjectDescriptorBase) : RustProjectDescriptorBase() {
    ...
    override fun testCargoProject(module: Module, contentRoot: String): CargoWorkspace {
        ...
        return delegate.testCargoProject(module, contentRoot).withStdlib(stdlib, CargoWorkspace.parseToCfgData(testDefaultCfgStdLib), rustcInfo)
    }
...
open class WithCustomStdlibRustProjectDescriptor(
    ...
    override fun testCargoProject(module: Module, contentRoot: String): CargoWorkspace =
        delegate.testCargoProject(module, contentRoot).withStdlib(stdlib!!, CargoWorkspace.parseToCfgData(testDefaultCfgStdLib))
