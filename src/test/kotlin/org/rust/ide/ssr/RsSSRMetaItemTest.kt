...
class RsSSRMetaItemTest : RsSSRTestBase() {
    fun `test InnerAttribute IDENTIFIER`() = doTest("""
        <warning descr="">#![id]</warning>
        <warning descr="">#![id(lit1)]</warning>
        <warning descr="">#![id = "lit1"]</warning>
        #![id2(id)]
    """, """#![id]""")
    ...
    fun `test InnerAttribute IDENTIFIER ( LITERAL )`() = doTest("""
        #![id()]
        <warning descr="">#![id(y1)]</warning>
        <warning descr="">#![id(y1, y2)]</warning>
        <warning descr="">#![id(y2, y1)]</warning>
        #![id(y2)]
        #![id2(y1)]
        #![id()]
        #![id = "y1"]
    ...
    fun `test InnerAttribute IDENTIFIER ( MetaItem )`() = doTest("""
        #![id()]
        #![id(y1)]
        <warning descr="">#![id(y1(z1))]</warning>
        <warning descr="">#![id(y1(z1), y2)]</warning>
        #![id(y1(z2))]
    """, """#![id(y1(z1))]""")
    ...
    fun `test InnerAttribute IDENTIFIER ( MetaSeq , MetaItem )`() = doTest("""
        ...
        #![id(y1)]
        #![id(y1, y2)]
        <warning descr="">#![id(y1, y2 = "z1")]</warning>
        <warning descr="">#![id(y2 = "z1", y3(), y1)]</warning>
        #![id2(y1)]
        #![id = "y1"]
    """, """#![id(y1, y2 = "z1")]""")

    fun `test OuterAttribute`() = doTest("""
        <warning descr="">#[id(y1 = "z1")]
        struct A;</warning>
        <warning descr="">#[id(y2, y1 = "z1")]
        struct B;</warning>
        #[id(y3)]
        struct C;
        #[id(y1(z2))]
