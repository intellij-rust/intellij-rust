...
class RsWithWhileSurrounderTest : RsSurrounderTestBase(RsWithWhileSurrounder()) {

    fun testNotApplicable1() = doTestNotApplicable("""
        fn main() {
    ...
    fun testNotApplicable2() = doTestNotApplicable("""
        fn main() {
            <selection>#![cfg(test)]
    ...
    fun testNotApplicable3() = doTestNotApplicable("""
        fn main() {
            loop<selection> {
                for 1 in 1..10 {
                    println!("Hello, world!");
    ...
    fun testApplicableComment() = doTest("""
        fn main() {
            <selection>// comment
            let mut server = Nickel::new();
            server.get("**", hello_world);
