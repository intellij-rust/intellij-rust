...
class RsSuspiciousAssignmentInspectionTest : RsInspectionsTestBase() {
    ...
    fun testDeref() = checkByText<RustSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = &32;
            let b;
    ...
    fun testNot() = checkByText<RustSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = true;
    ...
    fun testExpression() = checkByText<RustSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 10;
            let b = 47;
    ...
    fun testNoLeftSpace() = checkByText<RustSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 72;
    ...
    fun testCompactLeftPart() = checkByText<RustSuspiciousAssignmentInspection>("""
        fn main() {
    ...
    fun testCompactRightPart() = checkByText<RustSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 7;
    ...
    fun testNotApplied() = checkByText<RustSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 7;
            a =-3;
        }
    ...
    fun testFix1() = checkFixByText<RustSuspiciousAssignmentInspection>("Change to `a -= 1`", """
        fn main() {
            let mut a = 10;
    ...
    fun testFix2() = checkFixByText<RustSuspiciousAssignmentInspection>("Change to `a = -12 + 3`", """
        fn main() {
            let mut a = 10;
