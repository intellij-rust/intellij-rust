 ...
 */
class RsSuspiciousAssignmentInspectionTest : RsInspectionsTestBase() {

    fun testMinus() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 12;
    ...
    fun testDeref() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = &32;
            let b;
    ...
    fun testNot() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = true;
    ...
    fun testExpression() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 10;
            let b = 47;
    ...
    fun testNoLeftSpace() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 72;
    ...
    fun testCompactLeftPart() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
    ...
    fun testCompactRightPart() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 7;
    ...
    fun testNotApplied() = checkByText<RsSuspiciousAssignmentInspection>("""
        fn main() {
            let mut a = 7;
            a =-3;
        }
    ...
    fun testFix1() = checkFixByText<RsSuspiciousAssignmentInspection>("Change to `a -= 1`", """
        fn main() {
            let mut a = 10;
    ...
    fun testFix2() = checkFixByText<RsSuspiciousAssignmentInspection>("Change to `a = -12 + 3`", """
        fn main() {
            let mut a = 10;
