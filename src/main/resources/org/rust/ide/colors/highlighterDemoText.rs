...
<MACRO_CALL>macro_rules</MACRO_CALL><MACRO_CALL>!</MACRO_CALL> make_wrapper {
    (<MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>ty</MACRO_METAVARIABLE><MACRO_METAVARIABLE>:</MACRO_METAVARIABLE><MACRO_METAVARIABLE>ident</MACRO_METAVARIABLE>, <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>base_ty</MACRO_METAVARIABLE><MACRO_METAVARIABLE>:</MACRO_METAVARIABLE><MACRO_METAVARIABLE>ty</MACRO_METAVARIABLE>, <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>format_string</MACRO_METAVARIABLE><MACRO_METAVARIABLE>:</MACRO_METAVARIABLE><MACRO_METAVARIABLE>literal</MACRO_METAVARIABLE> <MACRO_REPEATING>$</MACRO_REPEATING><MACRO_REPEATING>(</MACRO_REPEATING>, <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>lu_ty</MACRO_METAVARIABLE><MACRO_METAVARIABLE>:</MACRO_METAVARIABLE><MACRO_METAVARIABLE>ty</MACRO_METAVARIABLE><MACRO_REPEATING>)</MACRO_REPEATING><MACRO_REPEATING>?</MACRO_REPEATING>) => {
        pub struct <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>serde_ty</MACRO_METAVARIABLE>(<MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>base_ty</MACRO_METAVARIABLE>);
        impl From<<MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>base_ty</MACRO_METAVARIABLE>> for <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>serde_ty</MACRO_METAVARIABLE> {
            fn from(base: <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>base_ty</MACRO_METAVARIABLE>) -> Self {
                Self(base)
            }
        }
        <MACRO_REPEATING>$</MACRO_REPEATING><MACRO_REPEATING>(</MACRO_REPEATING>
            impl From<<MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>lu_ty</MACRO_METAVARIABLE>> for <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>serde_ty</MACRO_METAVARIABLE> {
                fn from(lu: <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>lu_ty</MACRO_METAVARIABLE>) -> Self {
                    Self(lu.get())
                }
            }
            impl From<<MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>serde_ty</MACRO_METAVARIABLE>> for <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>lu_ty</MACRO_METAVARIABLE> {
                fn from(st: <MACRO_METAVARIABLE>$</MACRO_METAVARIABLE><MACRO_METAVARIABLE>serde_ty</MACRO_METAVARIABLE>) -> Self {
                    Self::new(st.0)
                }
            }
        <MACRO_REPEATING>)</MACRO_REPEATING><MACRO_REPEATING>?</MACRO_REPEATING>
