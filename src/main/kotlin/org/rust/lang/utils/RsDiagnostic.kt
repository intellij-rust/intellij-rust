...
sealed class RsDiagnostic(
    ...
    class StableAttributeUsedError(
        private val attr: RsAttr
    ) : RsDiagnostic(attr.metaItem) {
        override fun prepare() = PreparedAnnotation(
            ERROR,
            E0497,
            "Stable attribute can only be used in the standard library",
            fixes = listOf(RemoveAttrFix(attr))
        )
    }
...
enum class RsErrorCode {
    ...
    E0403, E0404, E0407, E0415, E0424, E0426, E0428, E0433, E0449, E0463, E0497,
