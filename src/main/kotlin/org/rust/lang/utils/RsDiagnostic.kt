...
sealed class RsDiagnostic(
    ...
    class BreakContinueInWhileConditionWithoutLoopError(
        ...
        override fun prepare() = PreparedAnnotation(
            ERROR,
            E0590,
            "`$kind` with no label in the condition of a `while` loop",
            fixes = fixes.toQuickFixInfo()
        )
    }
    ...
    class GenericDefaultParamCannotUseForwardError(
        element: PsiElement
    ) : RsDiagnostic(element) {
        override fun prepare() = PreparedAnnotation(
            ERROR,
...
enum class RsErrorCode {
    ...
    E0106, E0107, E0116, E0117, E0118, E0120, E0121, E0124, E0128, E0130, E0131, E0132, E0133, E0183, E0184, E0185, E0186, E0191, E0197, E0198,
    ...
    E0703, E0704, E0708, E0728, E0732, E0733, E0741, E0742, E0747, E0774, E0777, E0784, E0785;
