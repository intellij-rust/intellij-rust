...
/**
 * Determines if the string is a Rust end-of-line character.
 */
fun String.isRustEOL(): Boolean = equals("\r") || equals("\n") || equals("\r\n")

/**
 * Determines if the string contains a Rust end-of-line character.
 */
fun String.containsRustEOL(): Boolean = contains("\r") || contains("\n") || contains("\r\n")

/**
 * Escape string using Rust escaping rules.
 */
fun String.escapeRust(): String = TODO() // TODO: Implement this.
