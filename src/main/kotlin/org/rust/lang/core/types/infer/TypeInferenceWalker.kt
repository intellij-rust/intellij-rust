...
class RsTypeInferenceWalker(
    ...
    private fun inferIndexExprType(expr: RsIndexExpr): Ty {
        ...
        if (result != TyUnknown) {
            ...
            if (prevTy is TyReference && prevTy.mutability == Mutability.IMMUTABLE) {
                ...
                ctx.addAdjustment(containerExpr, Adjustment.BorrowReference(TyReference(lastTy, Mutability.IMMUTABLE)))
            }
        }
        return result
    }
