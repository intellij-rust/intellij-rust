...
class RsKeywordCompletionProvider(private vararg val keywords: String) : CompletionProvider<CompletionParameters>() {
...
private val ALWAYS_NEEDS_SPACE: Set<String> = setOf(
    "crate",
    "const",
    "enum",
    "extern",
