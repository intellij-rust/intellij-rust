...
abstract class RustTraitMethodMemberImplMixin(node: ASTNode) : RustCompositeElementImpl(node)
    ...
    override val declarations: Collection<RustDeclaringElement>
        get() = listOfNotNull(fnAnonParamsWithSelf.selfArgument) + fnAnonParamsWithSelf.anonParamList.orEmpty()
...
val RustTraitMethodMember.isStatic: Boolean get() = fnAnonParamsWithSelf.selfArgument == null
