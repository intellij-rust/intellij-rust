...
class RsFile(fileViewProvider: FileViewProvider) : PsiFileBase(fileViewProvider, RsLanguage),
                                                   RsMod,
...
val RsFile.hasUseExternMacrosFeature: Boolean
    get() = queryAttributes.hasAttributeWithArg("feature", "use_extern_macros")
