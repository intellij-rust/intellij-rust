...
interface RsMod : RsQualifiedNamedElement, RsItemsOwner, RsVisible {
     ...
     *
     * Reference: https://doc.rust-lang.org/reference.html#paths
     */
    val `super`: RsMod?
     ...
     *
     * This contortion is required because [org.rust.lang.core.psi.RsFile] is [RsMod], but we shouldn't override its
     * name.
     */
    val modName: String?
