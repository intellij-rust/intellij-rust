...
abstract class RustImplMethodImplMixinMember(node: ASTNode) : RustNamedElementImpl(node)
    ...
    override val declarations: Collection<RustDeclaringElement>
        get() = listOfNotNull(fnParamsWithSelf.selfArgument) + fnParamsWithSelf.paramList.orEmpty()
...
val RustImplMethodMember.isStatic: Boolean get() = fnParamsWithSelf.selfArgument == null
