...
val RsPath.hasColonColon: Boolean
    get() = stub?.hasColonColon ?: (coloncolon != null)

val RsPath.hasCself: Boolean
    get() = stub?.hasCself ?: (cself != null)
...
abstract class RsPathImplMixin : RsStubbedElementImpl<RsPathStub>, RsPath {
    ...
    override val referenceName: String
        get() = stub?.referenceName ?: referenceNameElement.text
