...
abstract class RsModItemImplMixin : RsStubbedNamedElementImpl<RsModItemStub>, RsModItem {
    ...
    override val crateRelativePath: String?
        get() = RsPsiImplUtil.modCrateRelativePath(this)
...
val RsModItem.hasMacroUse: Boolean
    get() = queryAttributes.hasAttribute("macro_use")

val RsModItem.pathAttribute: String?
