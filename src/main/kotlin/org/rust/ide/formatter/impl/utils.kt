...
val FN_DECLS = ts(FN_ITEM, FUNCTION, TRAIT_METHOD_MEMBER, IMPL_METHOD_MEMBER, BARE_FN_TYPE, LAMBDA_EXPR)

val ONE_LINE_ITEMS = ts(USE_ITEM, STATIC_ITEM, MOD_DECL_ITEM, EXTERN_CRATE_ITEM, TYPE_ITEM, INNER_ATTR)
