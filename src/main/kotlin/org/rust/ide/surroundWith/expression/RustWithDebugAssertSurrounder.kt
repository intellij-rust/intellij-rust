...
class RustWithDebugAssertSurrounder : RustExpressionSurrounderBase<RustExprStmtElementImpl>() {
    override fun getTemplateDescription(): String = "debug_assert!(expr);"

    override fun createTemplate(project: Project): RustExprStmtElementImpl =
        RustElementFactory.createStatement(project, "debug_assert!(a);") as RustExprStmtElementImpl
