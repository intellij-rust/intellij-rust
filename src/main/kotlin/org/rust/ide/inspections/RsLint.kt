...
/** Rust lints. */
enum class RsLint(val id: String, val defaultLevel: RsLintLevel = RsLintLevel.WARN) {
    ...
    fun levelFor(element: PsiElement): RsLintLevel =
        explicitLevel(element) ?: superModsLevel(element) ?: defaultLevel

    private fun explicitLevel(element: PsiElement): RsLintLevel? =
        element.ancestors
    ...
    private fun superModsLevel(element: PsiElement): RsLintLevel? =
        element.ancestors
