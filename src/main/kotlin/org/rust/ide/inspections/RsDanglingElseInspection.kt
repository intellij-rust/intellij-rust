...
class RsDanglingElseInspection : RsLocalInspectionTool() {
    override fun getDisplayName() = RsBundle.message("inspection.DanglingElse.name")
        ...
        object : RsVisitor() {
            override fun visitElseBranch(expr: RsElseBranch) {
                ...
                holder.registerProblem(
                    ...
                    RsBundle.message("inspection.DanglingElse.text"),
                    SubstituteTextFix.delete(
                        RsBundle.message("inspection.DanglingElse.remove.else"),
                        expr.containingFile,
                        elseEl.rangeWithPrevSpace(expr.prevSibling)
                    ),
                    SubstituteTextFix.replace(
                        RsBundle.message("inspection.DanglingElse.join.else.if"),
                        expr.containingFile,
