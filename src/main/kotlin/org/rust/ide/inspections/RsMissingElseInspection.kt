...
class RsMissingElseInspection : RsLocalInspectionTool() {
    override fun getDisplayName() = RsBundle.message("inspection.MissingElse.name")
        ...
        object : RsVisitor() {
            override fun visitExprStmt(expr: RsExprStmt) {
                ...
                holder.registerProblem(
                    ...
                    RsBundle.message("inspection.MissingElse.text"),
                    SubstituteTextFix.insert(
                        RsBundle.message("inspection.MissingElse.fix"),
