...
private fun colorFor(element: RsElement): RsColor? = when (element) {
    ...
    is RsConstant -> when (element.kind) {
        RsConstantKind.STATIC -> RsColor.VARIABLE
        RsConstantKind.MUT_STATIC -> RsColor.MUT_BINDING
        RsConstantKind.CONST -> RsColor.CONST_PARAMETER
    }
