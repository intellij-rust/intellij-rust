...
class RsErrorAnnotator : AnnotatorBase(), HighlightRangeExtension {
    ...
    override fun annotateInternal(element: PsiElement, holder: AnnotationHolder) {
        val annotationHolder = RsAnnotationHolder(holder)
        val visitor = object : RsVisitor() {
            override fun visitBaseType(o: RsBaseType) = checkBaseType(annotationHolder, o)
            override fun visitCondition(o: RsCondition) = checkCondition(annotationHolder, o)
            override fun visitConstant(o: RsConstant) = checkConstant(annotationHolder, o)
            override fun visitTypeArgumentList(o: RsTypeArgumentList) = checkTypeArgumentList(annotationHolder, o)
            override fun visitValueParameterList(o: RsValueParameterList) = checkValueParameterList(annotationHolder, o)
            override fun visitValueArgumentList(o: RsValueArgumentList) = checkValueArgumentList(annotationHolder, o)
            override fun visitStructItem(o: RsStructItem) = checkDuplicates(annotationHolder, o)
            override fun visitEnumItem(o: RsEnumItem) = checkEnumItem(annotationHolder, o)
            override fun visitEnumVariant(o: RsEnumVariant) = checkEnumVariant(annotationHolder, o)
            override fun visitFunction(o: RsFunction) = checkFunction(annotationHolder, o)
            override fun visitImplItem(o: RsImplItem) = checkImpl(annotationHolder, o)
            override fun visitLabel(o: RsLabel) = checkLabel(annotationHolder, o)
            override fun visitLifetime(o: RsLifetime) = checkLifetime(annotationHolder, o)
            override fun visitModDeclItem(o: RsModDeclItem) = checkModDecl(annotationHolder, o)
            override fun visitModItem(o: RsModItem) = checkDuplicates(annotationHolder, o)
            override fun visitUseSpeck(o: RsUseSpeck) = checkUseSpeck(annotationHolder,o)
            override fun visitPatBox(o: RsPatBox) = checkPatBox(annotationHolder, o)
            override fun visitPatField(o: RsPatField) = checkPatField(annotationHolder, o)
            override fun visitPatBinding(o: RsPatBinding) = checkPatBinding(annotationHolder, o)
            override fun visitPath(o: RsPath) = checkPath(annotationHolder, o)
            override fun visitNamedFieldDecl(o: RsNamedFieldDecl) = checkDuplicates(annotationHolder, o)
            override fun visitRetExpr(o: RsRetExpr) = checkRetExpr(annotationHolder, o)
            override fun visitTraitItem(o: RsTraitItem) = checkDuplicates(annotationHolder, o)
            override fun visitTypeAlias(o: RsTypeAlias) = checkTypeAlias(annotationHolder, o)
            override fun visitTypeParameter(o: RsTypeParameter) = checkDuplicates(annotationHolder, o)
            override fun visitConstParameter(o: RsConstParameter) = checkConstParameter(annotationHolder, o)
            override fun visitLifetimeParameter(o: RsLifetimeParameter) = checkLifetimeParameter(annotationHolder, o)
            override fun visitVis(o: RsVis) = checkVis(annotationHolder, o)
            override fun visitVisRestriction(o: RsVisRestriction) = checkVisRestriction(annotationHolder, o)
            override fun visitUnaryExpr(o: RsUnaryExpr) = checkUnary(annotationHolder, o)
            override fun visitBinaryExpr(o: RsBinaryExpr) = checkBinary(annotationHolder, o)
            override fun visitExternCrateItem(o: RsExternCrateItem) = checkExternCrate(annotationHolder, o)
            override fun visitDotExpr(o: RsDotExpr) = checkDotExpr(annotationHolder, o)
            override fun visitYieldExpr(o: RsYieldExpr) = checkYieldExpr(annotationHolder, o)
            override fun visitArrayType(o: RsArrayType) = collectDiagnostics(annotationHolder, o)
            override fun visitVariantDiscriminant(o: RsVariantDiscriminant) = collectDiagnostics(annotationHolder, o)
            override fun visitPolybound(o: RsPolybound) = checkPolybound(annotationHolder, o)
            override fun visitTraitRef(o: RsTraitRef) = checkTraitRef(annotationHolder, o)
            override fun visitCallExpr(o: RsCallExpr) = checkCallExpr(annotationHolder, o)
            override fun visitBlockExpr(o: RsBlockExpr) = checkBlockExpr(annotationHolder, o)
            override fun visitBreakExpr(o: RsBreakExpr) = checkBreakExpr(annotationHolder, o)
            override fun visitContExpr(o: RsContExpr) = checkContExpr(annotationHolder, o)
            override fun visitAttr(o: RsAttr) = checkAttr(annotationHolder, o)
            override fun visitRangeExpr(o: RsRangeExpr) = checkRangeExpr(annotationHolder, o)
            override fun visitTraitType(o: RsTraitType) = checkTraitType(annotationHolder, o)
            override fun visitSelfParameter(o: RsSelfParameter) = checkParamAttrs(annotationHolder, o)
            override fun visitValueParameter(o: RsValueParameter) = checkParamAttrs(annotationHolder, o)
            override fun visitVariadic(o: RsVariadic) = checkParamAttrs(annotationHolder, o)
            override fun visitPatStruct(o: RsPatStruct) = checkRsPatStruct(annotationHolder, o)
            override fun visitPatTupleStruct(o: RsPatTupleStruct) = checkRsPatTupleStruct(annotationHolder, o)
        }
