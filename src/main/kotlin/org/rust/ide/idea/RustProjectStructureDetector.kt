...
import org.rust.ide.idea.RustModuleType
import java.io.File
import javax.swing.Icon

class RustProjectStructureDetector : ProjectStructureDetector() {
    ...
    override fun setupProjectStructure(roots: MutableCollection<DetectedProjectRoot>, projectDescriptor: ProjectDescriptor, builder: ProjectFromSourcesBuilder) {
        ...
        val moduleDescriptor = ModuleDescriptor(root.directory, RustModuleType.INSTANCE, emptyList<DetectedSourceRoot>())
