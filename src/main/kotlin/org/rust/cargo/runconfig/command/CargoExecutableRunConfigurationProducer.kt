...
class CargoExecutableRunConfigurationProducer
    ...
    companion object {
        ...
        fun isMainFunction(fn: RsFunction): Boolean {
            val workspace = fn.cargoWorkspace ?: return false
            return fn.name == "main" && findBinaryTarget(workspace, fn.containingFile.virtualFile) != null
        }
        ...
        private fun findBinaryTarget(location: Location<*>): ExecutableTarget? {
            ...
            val workspace = rsFile.cargoWorkspace ?: return null
            return findBinaryTarget(workspace, file)
        }

        private fun findBinaryTarget(workspace: CargoWorkspace, file: VirtualFile): ExecutableTarget? {
            val target = workspace.findTargetByCrateRoot(file) ?: return null
