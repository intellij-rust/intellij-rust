        ...
        fun work() {
            ...
            schemas.forEach { schema ->
                ...
                if (isName != ThreeState.YES) {
                    suggestValues(schema, isName == ThreeState.YES)
                }
            }
...
//            }
        ...
        private fun hasSameType(variants: Collection<JsonSchemaObject>) =
            variants.mapNotNull { it.guessType() }.distinct().count() <= 1

        fun suggestValues(schema: JsonSchemaObject, isSurelyValue: Boolean) {
