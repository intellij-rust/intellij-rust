...
public class RustBoundImpl extends RustCompositeElementImpl implements RustBound {

  public RustBoundImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitBound(this);
